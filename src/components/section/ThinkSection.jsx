...
function ThinkSection() {
  return (
    ...
    >
      {/* Title */}
      <h1 className="text-5xl md:text-6xl lg:text-7xl mb-20">
        No lag. No waiting. No confusion. <br />
      </h1>

      {/* Grid */}
      <div className="max-w-6xl mt-10 mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">

        {/* Card 1 */}
        <div className="flex flex-col items-center justify-center">
          <img src={Home} alt="Offline First" className="w-10 h-10 mb-6" />
          <h2 className="text-2xl font-semibold mb-4">Instant updates</h2>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h2 className="text-2xl font-semibold mb-4">Always accessible</h2>
          <p className="max-w-xs text-gray-700">
            Your pipeline is ready when your team is
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <h2 className="text-2xl font-semibold mb-4">Full control</h2>
          <p className="max-w-xs text-gray-700">
            No dependency on scattered tools
          </p>
        </div>
